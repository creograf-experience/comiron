	      ...
	      if($data["person_id"]){
              ...
              //if($valid_request_json['state']){
                  ...
                  if($order_id){
                    ...
                    $this->sendXML($order_id,$shop_id,$sum,$person_id,$cart);
...
//var_dump($data);
      ...
      if(isset($id) and is_numeric($id)){
        ...
        if($data['products']){
          ...
          if($data["person_id"]){
	      $this->sendXML($id,$data['shop_id'],$data['sum'],$data['person_id'],$cart);
	  }
        }
    ...
    private function sendXML($order_id,$shop_id,$sum,$person_id,$cart){
      $priceorder = $this->model("orderprice");
