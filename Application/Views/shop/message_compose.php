...
<form method="post" action="/shop/messages/sendshop/<?php echo $vars['message_id']?>" id="<?php echo $vars['message_id']?>">
<input type="hidden" name="shopID" id="shopID" value="<?php echo $vars['shop_id']?>" />
<div class="news_compose">
   <div class="form_entry">
      <div class="form_label"><label for="title"><?php echo $this->t('profile','To'); ?></label></div>
        <!--
        <select name="groups[]" id="toMulti" multiple="multiple" style="width:364px">
    	...
    	<!-- option value=""><?php //echo $this->t('profile','Select one...'); ?>11</option-->	
		<?php
  ...
  <!-- div class="form_entry photoupload">
   ...
   <!-- div class="form_entry photoupload">
      <div class="form_label"><label for="photo"><?php echo $this->t('profile','Photo'); ?></label></div>
		<input id="message_photo_upload" name="UploadPhoto" type="file" multiple="true">		
	    <div id="queue"></div>
	    <div id="photos"></div>
	    
   </div>

      <div class="form_entry fileupload">
      <div class="form_label"><label for="photo"><?php echo $this->t('profile','Document'); ?></label></div>
		<input id="message_file_upload" name="UploadFile" type="file" multiple="true">		
	    <div id="queue2"></div>
   </div -->
   
  <!-- div class="form_entry" style="margin-top:12px">
    <div class="form_label"></div>
    <table class="markup"><tr><td><button type="submit" class="btn" id="news_send"><?php echo $this->t('profile','send'); ?></button></td><td>&nbsp;</td><td><button id="compose_cancel" class="btn"><?php echo $this->t('common','cancel'); ?></button></td></tr></table>
  </div-->
   ...
   <div class="body"><div class="icons"><br>
	...
	echo "<div><span><a href=\"#\" class=\"file\"><input id=\"message_photo_upload\" name=\"UploadPhoto\" type=\"file\" multiple=\"true\"></a></span></div>";
    ?>	
    </div></div>		
