...
//создать невидимый "черновик" новости, к которому можно будет прикреплять картинки
	...
	//echo $news_id;
if(isset($vars['news_id'])){
?>
<form method="post" action="/shop/news/send/<?php echo $vars['news_id']?>" id="<?php echo $vars['news_id']?>">
<div class="news_compose">
  <div class="form_entry">
      <div class="form_label"><label for="title"><?php echo $this->t('profile','Title'); ?></label></div>
 
      <input type="text" name="title" id="title" value=""  style="width:364px;"/>
    </div>
	<!-- div class="form_entry">
  ...
  <div class="form_entry">
      ...
      <textarea name="body" id="body" style="margin: 0px 0px 9px; width: 363px;"></textarea>
  </div>
  <!-- div class="form_entry">
...
<!--script>
	...
	$('#message_photo_upload').uploadify({
		...
		'script'    : '/profile/message_photo_upload/<?php if(isset($vars['news_id'])){ echo $vars['news_id']; } ?>',
		'cancelImg' : '/images/cancel.png',
		'multi'     : true,
		'auto'      : true,
		'folder'    : '/images/messages',
