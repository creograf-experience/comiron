...
//echo $vars['shop_id'];
        	...
        	echo "<div class=\"photo\">";
                if(!empty($vars['shop_id'])) {
                    echo "<a href=\"/shop/{$vars['shop_id']}\">";
                } else {
                    echo "<a href=\"/profile/{$vars['person']['id']}\">";
                }
        	...
        	if(!empty($vars['shop_id'])) {
                    if($vars['shop']['thumbnail_url']){
                            echo "<img class=\"smallavatar\" src=\"{$vars['shop']['thumbnail_url']}\">";
                    }else{
...
<form method="post" action="/profile/messages/send_inline/<?php echo $vars['message_id']?>" id="form<?php echo $vars['message_id']?>" to="<?php echo $vars['to'] ?>" class="message_post">
...
<div class="form_entry">
  ...
  <table class="markup"><tr><td>
	...
	<div class="buttons">
                <input type="hidden" name="shop_id" id="shop_id" value="<?php if(isset($vars['shop_id']) and !empty($vars['shop_id'])) { echo $vars['shop_id']; } ?>">
...
*/
			...
			$('input#img_<?php echo $vars['message_id']; ?>').uploadifive({
				...
				'buttonClass'  : 'uploadButton uploadPhoto',//attachphoto 
				'height':20,
			...
			$('input#file_<?php echo $vars['message_id']; ?>').uploadifive({
				...
				'buttonClass'  : 'uploadButton uploadFile',//attachphoto 
				'height':20,
				//'checkScript'      : 'check-exists.php',
				'formData'         : {
