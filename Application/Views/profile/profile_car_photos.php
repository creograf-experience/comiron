...
?>			
			            ...
			            <a class="thumbnail" object_id="<?php echo $media['object_id']?>" object_name="<?php echo $media['object_name']?>" owner_id="<?php echo $media['owner_id'];?>" id="<?php echo $media['id'];?>" href="<?php echo $media['thumbnail_url600']?>" thumbnail600="<?php echo $media['thumbnail_url600'];?>" thumbnail="<?php echo $media['thumbnail_url'];?>">
