...
fullExpandTitle : 'Real size',
restoreTitle : 'Кликните по изображение, для закрытия, нажмите и перетащите изображение, для перемещения.',
focusTitle : 'To the foreground',
...
outlineType : 'outer-glow', // 'drop-shadow', // set null to disable outlines
...
expand : function(a, params, custom) {
	try {
		...
		return false;		
	} catch (e) { alert(e.msg); return true; }	
},
