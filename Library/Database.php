...
//echo mysqli_client_encoding($this->db);
    }
    return true;
  }
...
//    return mysqli_fetch_all($res);
     // return mysqli_fetch_array($res);
  	...
  	unset($all[sizeof($all)-1]);
  	return $all;
  }
  
  public function fetch_all_assos($res, $result_type = MYSQLI_BOTH) {
    //return mysqli_fetch_all($res, $result_type);
  	$all = array();
  	while ($all[] = mysqli_fetch_assoc($res)) {}
  	unset($all[sizeof($all)-1]);
  	return $all;
